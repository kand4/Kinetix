  ...
  return (
    <>
      ...
      <div className="text-center relative z-10 max-w-6xl mx-auto px-4 pt-8">
        <h1 className="flex flex-col items-center justify-center font-bold tracking-tighter text-white mb-6 leading-[1.1]">
          {/* Brand Name KINETIX */}
          <span className="text-6xl sm:text-7xl md:text-9xl mb-2 font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-500 drop-shadow-[0_0_30px_rgba(255,255,255,0.3)] select-none">
            KINETIX
          </span>
          
          {/* Subheader */}
          <span className="text-2xl sm:text-3xl md:text-5xl font-light text-zinc-300">
            Bring anything to <span className="underline decoration-4 decoration-blue-500 underline-offset-4 md:underline-offset-8 text-white font-semibold">life</span>.
          </span>
        </h1>
        
        <p className="text-base sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-light">
          Gemini sees the code in everything. Drop in an old map, a floor plan, a diagram, or a doodle, and watch <span className="text-blue-400 font-bold">KINETIX</span> turn it into a working interactive simulation instantly.
        </p>
      </div>
    </>
  );
